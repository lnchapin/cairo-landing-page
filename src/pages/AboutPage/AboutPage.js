      ...
      <div className="content-grid">
        ...
        <div className="about-wrapper">
          <div className="about-content" style={{ color: textPrimary }}>
            ...
            <p>
              I'm a parrot so I <span className="highlight"> fly and talk a lot</span>. Mostly not-so-chim words like <span className="highlight"> 'hello', 'uh-oh', 'oooh'</span> and some choice swear words that my male human convinced me would get me famous on the internet. But haiyo, what is fame when I haven't reached sexual maturity? Anyways, I sometimes stream from the comfort of my cage for fun. My human has repeatedly warned me not to try and eat the Raspberry Pi - but why else would they name something after two of my favourite foods?
            </p>
            <p>
